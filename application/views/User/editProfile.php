...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            <!-- uploud form dari codeigneter 3, yang nantinya akan diarahkan ke method controller yang ada di file user.php -->
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="row">
                        <div class="col-sm-3">
                            <img src="<?= base_url('admin_assets/img/') . $user['image']; ?>" class="img-thumbnail">
                        </div>
                        <div class="col-sm-9">
